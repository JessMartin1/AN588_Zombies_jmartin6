...
f <- read.csv(f) #AM: This isn't working on my end. I had to change this to read variable "f"
...
print(mean_height)
(height_sd<-pop_sd(f$age, mean_height)) #AM: There is an error here, you're pulling on the age vector to compute height_sd
...
ggplot(f, aes(x = gender, y = years_of_education, fill = gender)) +
  ...
  theme(legend.title.align=0.5) 
```
<br>AM: I love the colors and the decoration. Mine is a bit boring right now because I wanted to make sure I had it write before I added more code or else I would get overwhelmed. But other than that I coded the same way!
## Question #3
...
#I like the use of the for loop to plot everything.Very nice.
```
...
## Peer Commentary: Allister Malik
